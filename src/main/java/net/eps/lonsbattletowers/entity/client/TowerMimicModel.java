...
public class TowerMimicModel<T extends TowerMimicEntity> extends SinglePartEntityModel<T> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData Body = modelPartData.addChild("Body", ModelPartBuilder.create(), ModelTransform.pivot(-2.0549F, 13.0F, -1.744F));
		...
		ModelPartData Pick_Base = Leg_Pick.addChild("Pick_Base", ModelPartBuilder.create().uv(100, 9).cuboid(-0.5F, 0.0F, 0.0F, 1.0F, 27.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 29.0F, 0.0F, 0.0F, 0.5236F));
		ModelPartData Leg_Pick_Base_r1 = Pick_Base.addChild("Leg_Pick_Base_r1", ModelPartBuilder.create().uv(92, 0).cuboid(-9.0F, -9.0F, 0.0F, 17.0F, 9.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(0.5F, 27.0F, 0.0F, 3.1416F, 0.0F, 0.0F));
		ModelPartData Pick_Holder = Leg_Pick.addChild("Pick_Holder", ModelPartBuilder.create().uv(2, 0).cuboid(-0.5F, 0.0F, 0.0F, 1.0F, 29.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 29.0F, -1.5708F, 0.0F, -3.1416F));
		...
		ModelPartData Shovel_Base = Leg_Shovel.addChild("Shovel_Base", ModelPartBuilder.create().uv(100, 9).cuboid(-0.5F, 0.0F, 0.0F, 1.0F, 27.0F, 0.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 29.0F));
		...
		ModelPartData Shovel_Holder = Leg_Shovel.addChild("Shovel_Holder", ModelPartBuilder.create().uv(2, 0).cuboid(-0.5F, 0.0F, 0.0F, 1.0F, 29.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 29.0F, -1.5708F, 0.0F, -3.1416F));
		...
		ModelPartData Scythe_Base = Leg_Scythe.addChild("Scythe_Base", ModelPartBuilder.create().uv(100, 9).mirrored().cuboid(-0.5F, 0.0F, 0.0F, 1.0F, 27.0F, 0.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(0.0F, 0.0F, 29.0F, 0.0F, 0.0F, -0.5236F));
		...
		ModelPartData Scythe_Holder = Leg_Scythe.addChild("Scythe_Holder", ModelPartBuilder.create().uv(2, 0).mirrored().cuboid(-0.5F, 0.0F, 0.0F, 1.0F, 29.0F, 0.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(0.0F, 0.0F, 29.0F, -1.5708F, 0.0F, 3.1416F));
		...
		ModelPartData Pitchfork_Base = Leg_Pitchfork.addChild("Pitchfork_Base", ModelPartBuilder.create().uv(100, 9).mirrored().cuboid(-0.5F, 0.0F, 0.0F, 1.0F, 27.0F, 0.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.pivot(0.0F, 0.0F, 29.0F));
		...
		ModelPartData Pitchfork_Holder = Leg_Pitchfork.addChild("Pitchfork_Holder", ModelPartBuilder.create().uv(2, 0).mirrored().cuboid(-0.5F, 0.0F, 0.0F, 1.0F, 29.0F, 0.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(0.0F, 0.0F, 29.0F, -1.5708F, 0.0F, 3.1416F));
		...
		ModelPartData Head = Body.addChild("Head", ModelPartBuilder.create(), ModelTransform.pivot(2.0F, -12.3F, 0.0F));
		...
		ModelPartData Lower_Jaw_Base = Lower_Jaw.addChild("Lower_Jaw_Base", ModelPartBuilder.create().uv(16, 125).cuboid(-8.0F, 5.0F, -8.0F, 16.0F, 3.0F, 0.0F, new Dilation(0.0F))
				.uv(32, 109).cuboid(8.0F, 5.0F, -8.0F, 0.0F, 3.0F, 16.0F, new Dilation(0.0F))
				.uv(32, 109).cuboid(-8.0F, 5.0F, -8.0F, 0.0F, 3.0F, 16.0F, new Dilation(0.0F))
				.uv(32, 125).cuboid(-8.0F, 5.0F, 8.0F, 16.0F, 3.0F, 0.0F, new Dilation(0.0F))
				.uv(16, 96).cuboid(-8.0F, 8.0F, -8.0F, 16.0F, 0.0F, 16.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, -8.0F));
		ModelPartData Lower_Jaw_Teeth = Lower_Jaw.addChild("Lower_Jaw_Teeth", ModelPartBuilder.create().uv(90, 120).cuboid(-3.0F, 0.0F, -8.0F, 6.0F, 5.0F, 0.0F, new Dilation(0.0F))
				.uv(64, 58).cuboid(-8.0F, 0.0F, 8.0F, 16.0F, 5.0F, 0.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, -8.0F));
		ModelPartData Lower_Jaw_Teeth_r1 = Lower_Jaw_Teeth.addChild("Lower_Jaw_Teeth_r1", ModelPartBuilder.create().uv(64, 55).cuboid(0.0F, -8.0F, -8.0F, 0.0F, 8.0F, 16.0F, new Dilation(0.0F)), ModelTransform.of(-8.0F, 5.0F, 0.0F, 0.0F, 0.0F, -0.2182F));
		ModelPartData Lower_Jaw_Teeth_r2 = Lower_Jaw_Teeth.addChild("Lower_Jaw_Teeth_r2", ModelPartBuilder.create().uv(64, 74).cuboid(0.0F, -5.0F, -8.0F, 0.0F, 5.0F, 16.0F, new Dilation(0.0F)), ModelTransform.of(8.0F, 5.0F, 0.0F, 0.0F, 0.0F, 0.2182F));
		ModelPartData Lower_Jaw_Teeth_r3 = Lower_Jaw_Teeth.addChild("Lower_Jaw_Teeth_r3", ModelPartBuilder.create().uv(68, 119).cuboid(-8.0F, -8.0F, 0.0F, 5.0F, 8.0F, 0.0F, new Dilation(0.0F))
				.uv(78, 119).cuboid(3.0F, -8.0F, 0.0F, 5.0F, 8.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 5.0F, -8.0F, 0.2182F, 0.0F, 0.0F));
		...
		ModelPartData Upper_Jaw_Teeth_r3 = Upper_Jaw_Teeth.addChild("Upper_Jaw_Teeth_r3", ModelPartBuilder.create().uv(113, 115).cuboid(-1.5F, 0.0F, 0.0F, 3.0F, 6.0F, 0.0F, new Dilation(0.0F))
				.uv(113, 115).cuboid(11.5F, 0.0F, 0.0F, 3.0F, 6.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(-6.5F, -1.2F, -8.0F, -0.2182F, 0.0F, 0.0F));
		ModelPartData Upper_Jaw_Base = Upper_Jaw.addChild("Upper_Jaw_Base", ModelPartBuilder.create().uv(16, 112).cuboid(-8.0F, -3.2F, -8.0F, 16.0F, 2.0F, 0.0F, new Dilation(0.0F))
				.uv(32, 96).cuboid(8.0F, -3.2F, -8.0F, 0.0F, 2.0F, 16.0F, new Dilation(0.0F))
				.uv(32, 96).cuboid(-8.0F, -3.2F, -8.0F, 0.0F, 2.0F, 16.0F, new Dilation(0.0F))
				.uv(32, 112).cuboid(-8.0F, -3.2F, 8.0F, 16.0F, 2.0F, 0.0F, new Dilation(0.0F))
	...
	public void setAngles(TowerMimicEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
		...
		this.updateAnimation(entity.spawnAnimationState, TowerMimicAnimations.MIMIC_SPAWN, animationProgress);
	}
